...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const body = `Name: ${formData.name}%0D%0ACompany: ${formData.company}%0D%0AEmail: ${formData.email}%0D%0AMessage: ${formData.message}`;

    window.location.href = `mailto:Hr@cloudeation.net?subject=${subject}&body=${body}`;
